class Trip < ActiveRecord::Base
  ...
  def validate_trip
    ...
    if time
      errors.add(:time, "is invalid") unless time.in_time_zone.to_s =~ /^2013-06-(0[1-9]|1[0-9]|2[0-9]|30) ([0-1][0-9]|2[0-3]):[0-5][0-9]:00 -0700$/
    else
      errors.add(:date, "is invalid") unless date.to_s =~ /^06\/(0[1-9]|1[0-9]|2[0-9]|30)\/2013$/
